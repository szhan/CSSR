...
public:
    ...
    int FindRoots(char charArray[], int intArray[]) { return FindRoots(m_root, charArray, intArray); }
...
protected:
    ...
    void FindStrings(TreeNode *root, int length, char *parentString, G_Array *tempArray);
